...
bulletgraph(x=graphx,ref=4500,limits=c(0,3500,5000,6000),name= "Service Learning Revenue 15-17",subname="(U.S. $ in \n thousands)",width=0.2)
```
...
#KPI
bulletgraph(x=max(FB_data$TotalBoxes),ref=80,limits=c(0,50,100,150),name= "Total Food Boxes",subname="(TotalBoxes)",width=0.2)
...
# KPI
bulletgraph(x=max(mr$X.10, na.rm=TRUE),ref=4500,limits=c(0,3500,5500,7000),name= "Market Revenue",subname="(U.S. $ in \n thousands)",width=0.2)
```
